...
class Default_Form_EditNews extends Zend_Form
{
	public function init(){
		...
		$this->addElement('text','title',array('required'=>true,'label'=>'Article Title','size'=>75,'validators'=>array('NotEmpty',array('stringLength',8)),'filters'=>array('StripTags','StringTrim')));
       	$this->addElement('textarea','summary', array('required'=>true,'label'=>'Article Summary','rows'=>4,'validators'=>array('NotEmpty'),'filters'=>array('StripTags','StringTrim')));
